...
namespace ProyectoRestaurante.DAO
{
    class ProductosDao:ConexionBD
    {
        ...
        public List<ProductosDto> VerProductos()
        {
            ...
            while (LeerFilas.Read())
            {
                ListaGenerica.Add(new ProductosDto
                {
                    ...
                    Nombre_Producto = LeerFilas.GetString(1),
                    Codigo_Producto = LeerFilas.GetString(2),
                    Precio_Producto = LeerFilas.GetInt32(3),
        ...
        public void CreateProductos(string nombre_prod, string cod_prod, int precio_prod, int stock_prod) 
        {
        ...
        public void UpdateProductos(int id_prod, string nombre_prod, string cod_prod, int precio_prod, int stock) 
        {
