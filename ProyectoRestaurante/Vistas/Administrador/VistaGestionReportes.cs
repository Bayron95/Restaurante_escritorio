...
namespace ProyectoRestaurante
{
    public partial class VistaGestionReportes : Form
    {
        ...
        private void btnInfMensual_Click(object sender, EventArgs e)
        {
            VistaFormatoDoc vtdoc = new VistaFormatoDoc();
            vtdoc.Show();
        }

        private void btnInfSemanal_Click(object sender, EventArgs e)
        {
            VistaFormatoDoc vtdoc = new VistaFormatoDoc();
            vtdoc.Show();
        }
